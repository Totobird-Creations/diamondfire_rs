...
unsafe extern "C" {
    ...
    pub safe fn DF_CONST__Potion() -> &'static df_potion;

    /// Creates an arbitrary item.
    ///
    /// No assumption should be made about the item type or data.
    pub safe fn DF_CONST__Item() -> &'static df_item;
